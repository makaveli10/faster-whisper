...
* [WhisperLive](https://github.com/collabora/WhisperLive) is a nearly-live implementation of OpenAI's Whisper and uses faster-whisper as the backend to transcribe in real-time.
